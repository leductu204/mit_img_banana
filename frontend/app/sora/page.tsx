...
import { Download, Link as LinkIcon, AlertCircle, Lightbulb, Copy, Bell, Coins } from "lucide-react";
    ...
    <ProtectedRoute>
      <div className="flex flex-col min-h-screen bg-[#0A0E13] font-sans selection:bg-[#00BCD4] selection:text-white">
        ...
        <main className="flex-grow flex flex-col items-center justify-center w-full px-6 py-12">
          ...
          <div className="w-full max-w-[800px] flex flex-col items-center text-center mb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <p className="text-[#9CA3AF] text-lg max-w-xl mb-10">
          ...
          {!downloadLink && (
            <div className="w-full max-w-[800px] mt-4 flex justify-center animate-in fade-in slide-in-from-bottom-8 duration-1000">
                <div className="bg-[#1F2833] border border-white/10 rounded-xl p-8 flex gap-6 items-center shadow-lg hover:border-[#00BCD4]/30 transition-colors w-full">
                    <div className="shrink-0 size-24 bg-[#252D3D] rounded-xl flex items-center justify-center overflow-hidden relative hidden sm:flex">
                        <div className="absolute top-5 left-4 w-12 h-1.5 bg-white/10 rounded-full"></div>
                        <div className="absolute top-9 left-4 w-8 h-1.5 bg-white/10 rounded-full"></div>
                        <div className="absolute bottom-3 right-3 p-1.5 bg-[#00BCD4] rounded shadow-lg text-white">
                            <Copy className="w-5 h-5" />
                        </div>
                        <div className="absolute inset-0 bg-gradient-to-tr from-transparent to-white/5 pointer-events-none"></div>
                    </div>
                    <div className="flex flex-col flex-1 text-left">
                        <h5 className="text-white font-bold text-lg mb-2 flex items-center gap-3">
                            <Lightbulb className="w-5 h-5 text-[#00BCD4]" />
                            How to get the link?
                        </h5>
                        <p className="text-[#B0B8C4] text-base leading-relaxed">
                            Navigate to the video on Sora, click the <span className="text-white font-semibold">Share</span> icon, and select <span className="text-white font-semibold">Copy Link</span> before pasting above.
                        </p>
                    </div>
                </div>
            </div>
